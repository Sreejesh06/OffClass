...
// Note: Using standard classnames instead of cn since utils might not be present or needed for this basic setup.
  ...
  return (
    ...
    >
      <svg
        ...
        className="lucide lucide-grip-vertical opacity-80"
      >
